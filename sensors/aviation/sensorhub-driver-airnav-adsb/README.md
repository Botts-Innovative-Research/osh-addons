...
The AirNav ADS-B driver connects to a dump1090 SBS-1/BaseStation (port 30003) or Beast (port 30005) TCP stream and publishes aircraft identification, position, altitude, and velocity observations.
