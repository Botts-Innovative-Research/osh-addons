 ...
 * {@link VideoOutput} for a single Esprit video URL (MJPEG over HTTP,
 ...
 * Esprit driver (e.g. one MJPEG + one H.264 output).
 * </p>
 */
class EspritVideoStream {
    private static final Logger logger = LoggerFactory.getLogger(org.sensorhub.impl.sensor.esprit.EspritVideoStream.class);

    private final EspritCameraDriver parent;
    private final String outputName;
    private final String sourceUrl;
    private final String commandLineArgs;

    private MpegTsProcessor mpegTsProcessor;
    private VideoOutput<EspritCameraDriver> videoOutput;
    private ExecutorService executor;

    /**
     * @param parent            Esprit driver that owns this stream.
     ...
     */
    EspritVideoStream(EspritCameraDriver parent, String outputName, String sourceUrl, String commandLineArgs) {
        this.parent = parent;
    ...
    void init() throws SensorException {
        executor = Executors.newSingleThreadExecutor(r -> {
            Thread t = new Thread(r, "Esprit-ffmpeg-" + outputName);
            t.setDaemon(true);
            return t;
        });
     ...
     */
    VideoOutput<EspritCameraDriver> getOutput() {
        return videoOutput;
    }
