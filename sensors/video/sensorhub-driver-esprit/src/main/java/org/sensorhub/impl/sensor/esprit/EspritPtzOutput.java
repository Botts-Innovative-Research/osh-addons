...
public class EspritPtzOutput extends AbstractSensorOutput<EspritCameraDriver>
{
    ...
    public EspritPtzOutput(EspritCameraDriver driver)
    {
                ...
                public void run()
                {
                    ...
                    try
                    {
                        ...
                        if (lines == totalReads) {
                            ...
                            eventHandler.publish(new DataEvent(latestRecordTime, org.sensorhub.impl.sensor.esprit.EspritPtzOutput.this, latestRecord));
                        } else {
                            throw new SensorException("Invalid sensor data from Esprit camera. Esprit url: " + ptzURL.toString());
                        }
                    }
                    catch (Exception e)
                    {
